      ...
      <div className=" grid grid-cols-2 gap-5  container mx-auto my-6 py-3 px-2  items-center bg-[#FFFFFF] ">
        <div className="grid justify-between space-y-3 px-5 ">
          ...
          <p className="py-6 text-[#475569] text-[18px] ">
            ...
            them side by side, and put together the stack that fits your <br />
            next project.
          </p>

          <div className="flex gap-2.5 ">
            <button className="btn bg-linear-to-r from-[#F97316] to-[#EC4899] text-sm font-semibold text-white">
        ...
        <div className="flex items-center mx-auto ">
          <img alt="hero image" src={HeroImage} className="" />
        </div>
      </div>
    </section>
  );
